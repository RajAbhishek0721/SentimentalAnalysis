...
Original file is located at
    https://colab.research.google.com/github/aayu-7/SentimentAnalysis/blob/main/Sentiment_Analysis.ipynb

# **Sentiment Analysis**

This is a notebook containing **Sentiment Analysis** Mini Project on *Amazon Musical Instruments Reviews*.
...
dataset = pd.read_csv("/content/Musical_instruments_reviews.csv.zip")
